...
const SubBar = ({ allCompanies, affectedCompanies }) => {
  ...
  const handleMyTrack = () => {
    ...
    var config = {
      method: "get",
      url: "https://stonks-bandito.herokuapp.com/stock/user/tracking",
      headers: {
  ...
  const handleTrack = (companyName, symbol) => {
    ...
    var config = {
      method: "post",
      url: "https://stonks-bandito.herokuapp.com/stock/track",
      headers: {
        "auth-token": sessionStorage.getItem("token"),
      },
      data: data,
  ...
  const handleStopTrack = (companyName, symbol) => {
    ...
    var config = {
      method: "post",
      url: "https://stonks-bandito.herokuapp.com/stock/track/stop",
      headers: {
        "auth-token": sessionStorage.getItem("token"),
      },
      data: data,
